...
const AdminGallery = () => {
    ...
    const fetchUserImages = async (userId) => {
        ...
        setError(null);
        try {
            const response = await fetch(`${API_URL}/image_capture/users/${userId}/images`, { // ' to "" see if works
                method: 'GET',
                headers: {
            ...
            if (response.ok) {
                ...
                return {
                    ...image,
                    image_url: image.image_path ? `${API_URL}/image_capture/${image.image_path}` : null
                };
            });
    ...
    const handleDeleteImage = async () => {
        if (selectedImage) {
            try {
                const response = await fetch(`${API_URL}/image_capture/${selectedImage.id}/delete`, {
                    method: 'DELETE',
                    headers: {
                        'Authorization': `Bearer ${adminAccessToken}`
                    }
